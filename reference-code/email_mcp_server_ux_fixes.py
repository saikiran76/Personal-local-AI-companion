            ...
            "result": {
                "tools": [
                    ...
                    },
                    {
                        ...
                        "description": "Open the user's OS default email app (like Outlook or Apple Mail) pre-filled with the drafted details so they can hit 'Send'. Use this when the user explicitly wants to send the email.",
                        "inputSchema": {
                            "type": "object",
                            "properties": {
                                "to": {"type": "string"},
